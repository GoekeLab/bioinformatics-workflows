...
fastQCone = Job.wrapJobFn(apiDockerCall,
                        ...
                        parameters=['fastqc', '-o', '/home/hexotical/bioninformatics-workflows/toil/python', 'data/reads_1.fq', 'data/reads_2.fq'])

salmonIndex = Job.wrapJobFn(apiDockerCall,
                        image='combinelab/salmon',
                        working_dir='/home/hexotical/bioninformatics-workflows/toil/python',
                        parameters=['salmon', 'index', '-t', '/home/hexotical/bioinformatics-workflows/toil/python/data/transcriptome.fa', '-i', 'index'])
...
#AddChildren
salmonQuant = Job.wrapJobFn(apiDockerCall,
                        image='combinelab/salmon',
                        working_dir='/home/hexotical/bioninformatics-workflows/toil/python',
                        parameters=['salmon', 'quant', '-i', 'index', '-l', 'A', '-1', 'data/reads_1.fq', '-2', 'data/reads_2.fq', '--validateMappings', '-o', 'quant'])
